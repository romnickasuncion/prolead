...
class CustomersAll extends Component {
    constructor(props) {
        ...
        this.formUserChange         = this.formUserChange.bind(this);
    ...
    loadCompanies(page) {
        axios({
            method: 'GET',
            url: `/api/companies?fetch=parent_only&page=${page}`,
            headers: {
    ...
    render() {
        let {users,user,companies,company,showDeleteModal,showFormModal,showEditFormModal,updateForm,company_errors,user_errors,page_limit,current_page,last_page,page_start,page_end,showMassDeleteModal,check_all,parent_companies} = this.state;
        let container;
